						...
						$count=0;
							...
							while($row=$result->fetch_assoc()){
								...
								if($count==3){
									...
									echo '<tr>
								<td><a href="tendermenu.php?q='.$fieldname1.'">'.$fieldname1.'</a></td>
								<td><a href="tendermenu.php?q='.$fieldname2.'">'.$fieldname2.'</a></td>
								<td><a href="tendermenu.php?q='.$fieldname3.'">'.$fieldname3.'</a></td>
								</tr>'
							;
							$count=0;
								}
								if($r==1 and $count1==$numrow){
									...
									echo '<tr><td><a href="tendermenu.php?q='.$fieldname4.'">'.$fieldname4.'</a></td></tr>';
								}
								...
								if($r==2 and $count1==$numrow){
									...
									echo '<tr><td><a href="tendermenu.php?q='.$fieldname5.'">'.$fieldname5.'</a></td>;
											<td><a href="tendermenu.php?q='.$fieldname6.'">'.$fieldname6.'</a></td></tr>';
								}
