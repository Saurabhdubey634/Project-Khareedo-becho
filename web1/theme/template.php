	...
	<header>
		<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
			<a class="navbar-brand" href="index.html">
				<img src="images/logo4.png" class="logo img-fluid" alt="">SHELL AMAZE.COM
			</a>
			...
			<div class="collapse navbar-collapse navbar-toggle " id="navbarNavAltMarkup">
				<ul class="navbar-nav mx-xl-auto">
					...
					<li>
						<a class="nav-link text-uppercase" href="ECommerce/LogSignModel.php">LOGIN/SIGN UP</a>
					</li>
					<li>
						<a class="nav-link text-uppercase" href="ECommerce/index.php">PRODUCTS</a>
					</li>
					<li>
						<a class="nav-link text-uppercase" href="about.html">BUILDER</a>
					</li>
					<li>
						<a class="nav-link text-uppercase" href="developer.php" target="_blank">DEVELOPER</a>
					</li>
