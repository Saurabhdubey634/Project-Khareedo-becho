...
<body data-spm="8293689" >
    ...
    <link href="//s.alicdn.com/@g/sc/header-footer/0.0.31/sc-header-footer/header/entrances/global-header-new/header.css" rel="stylesheet" type="text/css">
<div
    id="J_SC_header"
    ...
    <header class="sc-hd-header">
        <!-- mobile -->
		  <div class="header_top" id="headertop"><!--header_top-->
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills" id="t1">
                <li><a href="#"></a></li>
                <li><a href="#"></a></li>
				<li><font color="white">For Bulk Order Helpline Number: +919819595467</font></li>
              </ul>
            </div>
          </div>
        ...
        <div class="sc-hd-row sc-hd-main">
                  ...
                  <form action="<?php echo web_root?>index.php?q=product" method="POST">
                    <div class="ui-searchbar-main" style="margin-left: 102px;">
                      <input type="text" class="ui-searchbar-keyword" name="SearchText" autocomplete="off"
                        x-webkit-speech="x-webkit-speech" x-webkit-grammar="builtin:translate" lang="en" placeholder="Search here..." />
                    </div>
            ...
            <div class="sc-hd-cell sc-hd-m-notify sc-hd-float-r sc-hd-text-right">
              <div class="J-hd-m-notify-tab sc-hd-hide-s sc-hd-ms-tab sc-hd-ms-ma J-sc-hd-ms-ma" data-tab="ma">
                ...
                <?php }else{ ?> 
                <li><a data-target="#smyModall" data-toggle="modal"  href=""> Login/signup</a></li>
              ...
              <div class="J-hd-m-notify-tab sc-hd-hide-s sc-hd-ms-tab sc-hd-ms-order J-sc-hd-ms-order" data-tab="order">
                <div class="J-hd-m-notify-tab-trigger sc-hd-ms-trigger sc-hd-ms-last" data-tab="order">
                  <div class="sc-hd-icon-container"><a  data-val="ordericon"
                  ...
                  <div class="sc-hd-text-container"><a title="Orders"
                      href="//biz.alibaba.com/order/list.htm?tracelog=hd_order" target="_blank"></a></div>
                </div>
              </div>
              <div class="J-hd-m-notify-tab sc-hd-ms-tab sc-hd-ms-cart J-sc-hd-ms-cart" data-tab="cart">
                <div class="J-hd-m-notify-tab-trigger sc-hd-ms-trigger sc-hd-ms-last" data-tab="cart">
                  <div class="sc-hd-icon-container"><a  data-val="carticon"
                  ...
                  <div class="sc-hd-text-container"><a title="Cart"
                      href="//carp.alibaba.com/purchaseList?tracelog=miniCart" target="_blank" data-val="Cart" data-type="text"></a></div>
                </div>
              </div>
            </div>
        </div>
      ...
      <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li class="dropdown"><a href="#"><i class="fa fa-bars"></i>Categories<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu" id="cat">
                                       <?php 
                                            $mydb->setQuery("SELECT * FROM `tblcategory`");
                                            $cur = $mydb->loadResultList();
                                           foreach ($cur as $result) { 
                                       echo '<li><font color="black" <a href="index.php?q=product&category='.$result->CATEGORIES.'" >'.$result->CATEGORIES.'</a></font></li>';
                                        } ?> 
                                    </ul>
                                </li> 
						...
						<div class="bs-slider-overlay">
							<div class="container">
								...
								<div class="w3l-slide-text">
									...
									<h3 data-animation="animated zoomInRight">ONE STOP SOLUTION FOR THE ENTIRE CONSTRUCTION INDUSTRY.</h3>
					...
					<img src="img/img11.jpg" alt=" "  />
						<div class="bs-slider-overlay">
							<div class="container">
								...
								<div class="w3l-slide-text">
									<p class="aos-init aos-animate" data-aos="fade-down">Excepteur sint occaecat cupidatat non proident</p>
									<h3 data-animation="animated zoomInRight">GET THE INFORMATION ABOUT ALL THE TENDERS RELATED TO ALL SECTORS UNDER ONE ROOF</h3>
									<a href="services.html" target="_blank" class="button-style" data-animation="animated fadeInDown" data-aos="fade-down">View
										Our Services</a>
								</div>
							</div>
					...
					<img src="img/s2.jpg" alt=" "  />
						<div class="bs-slider-overlay">
							<div class="container">
								...
								<div class="w3l-slide-text">
									<p class="aos-init aos-animate" data-aos="fade-down">Excepteur sint occaecat cupidatat non proident</p>
									<h3 data-animation="animated zoomInRight">WE PROVIDE ALL TYPES OF PRODUCTS REQUIRED FOR CONSTRUCTION WORK AT ONE PLACE.</h3>
									<a href="services.html" target="_blank" class="button-style" data-animation="animated fadeInDown" data-aos="fade-down">View
										Our Services</a>
								</div>
							</div>
					...
					<img src="img/s4.jpg" alt=" "  />
						<div class="bs-slider-overlay">
							<div class="container">
								...
								<div class="w3l-slide-text">
									<p class="aos-init aos-animate" data-aos="fade-down">Excepteur sint occaecat cupidatat non proident</p>
									<h3 data-animation="animated zoomInRight">USER WILL BE ABLE TO ACCESS THIS WEBSITE ONLY WHEN THEY ARE REGISTERED USER.</h3>
									<a href="web1/services.html" target="_blank" class="button-style" data-animation="animated fadeInDown" data-aos="fade-down">View
										Our Services</a>
								</div>
							</div>
						</div>
					...
					<img src="img/s6.jpg" alt=" "  />
						<div class="bs-slider-overlay">
							<div class="container">
								...
								<div class="w3l-slide-text">
									<p class="aos-init aos-animate" data-aos="fade-down">Excepteur sint occaecat cupidatat non proident</p>
									<h3 data-animation="animated zoomInRight">USER WILL BE ABLE TO PREPARE QUOTATIONS FOR THE PROJECTS LISTED UNDER DEVELOPER SECTION.</h3>
									<a href="web1/services.html" target="_blank" class="button-style" data-animation="animated fadeInDown" data-aos="fade-down">View
										Our Services</a>
								</div>
							</div>
      ...
      <div class="row">
        ...
        <div class="col-sm-12 padding-right">
          <div class="features_items"><!--features_items-->
            ...
            WHERE pr.`PROID`=p.`PROID` AND  p.`CATEGID` = c.`CATEGID`  AND PROQTY>0 AND p.Payment='Payment' ";
            $mydb->setQuery($query);
            $cur = $mydb->loadResultList();
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      <img src="<?php  echo web_root.'admin/products/'. $result->image1; ?>" alt="" />
                      <h2>&#8369 <?php  echo $result->PRODISPRICE; ?></h2>
                      <p><?php  echo    $result->PRODESC; ?></p>
					   <?php     
                            if (isset($_SESSION['CUSID'])){  

                              echo ' <a href="'.web_root. 'cart.php?proid='.$result->PROID.'" title="Add to wishlist"><button type="submit" name="btnorder" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button></a></a>
                            ';

                             }else{
                               echo   '<a href="#" title="Add to wishlist" class="proid"  data-target="#smyModal" data-toggle="modal" data-id="'.  $result->PROID.'"> <button type="submit" name="btnorder" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button></a></a>
                            ';
                            }  
                            ?>
                        ...
                        <p><?php  echo    $result->PRODESC; ?></p>
						 <?php     
                            if (isset($_SESSION['CUSID'])){  
                              ...
                              echo ' <a href="cart.php?proid='.$result->PROID.'" title="Add to wishlist">view</a></a>
                            ';
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 w3ls-left-copy text-lg-left text-center">
					<p class="copy-right-grids text-white">© 2020 Outdoor. All Rights Reserved | Design by
						<a href="#" target="_blank">Khareedo Becho.com</a>
					</p>
				</div>
				<div class="col-lg-4 w3ls-left-copy text-lg-right text-center">
					<p class="text-white">
						<i class="fas fa-phone mr-2"></i> +919819595466</p>
				</div>
			</div>
		</div>
	</div>
