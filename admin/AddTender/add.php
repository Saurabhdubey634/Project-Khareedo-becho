              ...
              <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            ...
                            "Owner Name" type="text" value="<?php echo $res->FNAME .' '.$res->LNAME; ?>">
                      </div>
                    </div>
                  </div> 
                   ...
                   <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            ...
                            "+91 0000000000" type="number" value="<?php echo $res->PHONE ; ?>">
                      </div>
                    </div>
                  </div> 
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            ...
                            "About Product line1" type="text" value="">
                      </div>
                    </div>
                  </div>  
				  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            ...
                            "About Product line 2" type="text" value="">
                      </div>
                    </div>
                  </div>  
				  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            ...
                            "About Product line 3" type="text" value="">
                      </div>
                    </div>
                  </div>  
					<div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            <textarea class="form-control input-sm" id="PRODESC" name="SPECIFICATION" cols="1" rows="3" ></textarea>
                      </div>
                    </div>
                  </div>  
                 ...
                 <div class="form-group">
					...
					<label class="col-md-4 control-label" for=
                      "CATEGORY">Location:</label>
						...
						<select class="form-control input-sm" name="location" id="CATEGORY">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                      <input type="file" name="image1" value="" id="image"/>
                      </div>
                    </div>
                  </div>
				  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                      <input type="file" name="image2" value="" id="image"/>
                      </div>
                    </div>
                  </div>
				  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                      <input type="file" name="image3" value="" id="image"/>
                      </div>
                    </div>
                  </div>
